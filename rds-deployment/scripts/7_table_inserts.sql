...
--============================================================================================================================
---- SECURITIES INSERT TO STAGING - START -------------------------------------------------------------------------------------
--============================================================================================================================

exec msdb.dbo.rds_download_from_s3
      @s3_arn_of_file='arn:aws:s3:::financial-analytics-g5/securities.csv',
      @rds_file_path='D:\S3\securities.csv',
      @overwrite_file=1;


BULK INSERT  financial_analytics.dbo.securities FROM 'D:\S3\securities.csv'
WITH (
    FORMAT='CSV',
    FIRSTROW = 2,
    MAXERRORS = 0,
...
--============================================================================================================================
---- SECURITIES INSERT TO STAGING - END -------------------------------------------------------------------------------------
--============================================================================================================================
